// ===================== GLOBAL =====================
let products = []; // Danh sách sản phẩm từ API
let cart = [];     // Giỏ hàng
    ...
    list.forEach(p => {
        ...
        col.innerHTML = `
            <div class="card mb-3 h-100">
                <img src="${p.hinhAnh}" alt="${p.tenSp}" class="card-img-top" style="height:180px; object-fit:cover;" />
...
function checkout() {
    ...
    // TODO: Gọi API thanh toán sau này
