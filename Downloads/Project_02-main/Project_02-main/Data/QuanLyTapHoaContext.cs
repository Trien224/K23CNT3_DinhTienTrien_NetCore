...
public partial class QuanLyTapHoaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaCthd).HasName("PK__ChiTietH__1E4FA771F9E92959");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaS__AA9515BF9EDE2DBA");
        ...
        {
            entity.HasKey(e => e.MaHd).HasName("PK__HoaDon__2725A6E087EE425C");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1EAFCC8892");

            entity.ToTable("KhachHang");

            entity.HasIndex(e => e.Email, "UQ__KhachHan__A9D105346BD7D502").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiSanP__730A5759BB4F9E2C");
        ...
        {
            entity.HasKey(e => e.MaVoucher).HasName("PK__MaGiamGi__0AAC5B1172421AE8");
        ...
        {
            entity.HasKey(e => e.MaQtv).HasName("PK__QuanTriV__396E999652473148");

            entity.ToTable("QuanTriVien");

            entity.HasIndex(e => e.Email, "UQ__QuanTriV__A9D10534A07DA8FB").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__2725081CD2CA6D4D");
