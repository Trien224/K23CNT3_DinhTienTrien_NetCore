...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaCthd).HasName("PK__ChiTietH__1E4FA77198941B3C");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaS__AA9515BFDBF411FC");
        ...
        {
            entity.HasKey(e => e.MaHd).HasName("PK__HoaDon__2725A6E0068E672E");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1E03EE3E73");

            entity.ToTable("KhachHang");

            entity.HasIndex(e => e.Email, "UQ__KhachHan__A9D10534AC371022").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiSanP__730A575962C8EAB4");
        ...
        {
            entity.HasKey(e => e.MaVoucher).HasName("PK__MaGiamGi__0AAC5B11E04367A2");
        ...
        {
            entity.HasKey(e => e.MaQtv).HasName("PK__QuanTriV__396E9996F744B597");

            entity.ToTable("QuanTriVien");

            entity.HasIndex(e => e.Email, "UQ__QuanTriV__A9D10534256E7FE3").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__2725081C90943383");
